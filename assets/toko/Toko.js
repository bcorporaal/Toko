var Toko = (function () {
  ...
  */
  ...
  //
  Toko.prototype.getPaletteSelection = function (selectionList, sorted = false) {
    let filtered = this._getPaletteSelectionRaw(selectionList, sorted);
    return this.formatForTweakpane(filtered, 'name');
  };
